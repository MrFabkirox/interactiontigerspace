    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database'  => env('DB_DATABASE', 'localhost'),//forge
        ...
        'pgsql' => [
            ...
            'database' => env('DB_DATABASE', 'dbrj48k143k56g'),
            'username' => env('DB_USERNAME', 'pmzuifljjkratd'),
            'password' => env('DB_PASSWORD', 'TTJ12vZP0X9Lgjl_FHOXzEFJSp'),
            'charset'  => 'utf8',
            'prefix'   => '',
            'schema'   => 'public',
        ],
